    ...
    return (
        <div className="app-content-padding space-y-6">
            <div className="ios-card text-center py-16">
                <span className="material-symbols-outlined text-5xl text-[hsl(var(--admin-text-muted))] mb-4 block">medical_services</span>
                <h1 className="text-2xl font-bold text-[hsl(var(--admin-text-main))] mb-2">Sick Bay</h1>
