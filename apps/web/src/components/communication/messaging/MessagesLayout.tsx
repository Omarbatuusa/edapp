...
export function MessagesLayout({ children, header, footer, className = '' }: MessagesLayoutProps) {
    return (
        <div className={`fixed inset-0 z-50 flex flex-col bg-slate-50 dark:bg-[#0B1120] text-foreground overflow-hidden md:relative md:min-h-screen md:h-auto md:z-0 ${className}`}>
