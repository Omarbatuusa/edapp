...
// Priority ISO2 set — excluded from alphabetical tail to avoid duplicates
const PRIORITY_SET = new Set(PRIORITY_COUNTRIES.map(c => c.iso2));

const REST_COUNTRIES: CountryOption[] = [
    ...
    { iso2: 'AG', name: 'Antigua and Barbuda', dialCode: '+1-268', flag: '🇦🇬' },
    ...
    { iso2: 'BS', name: 'Bahamas', dialCode: '+1-242', flag: '🇧🇸' },
    { iso2: 'BH', name: 'Bahrain', dialCode: '+973', flag: '🇧🇭' },
    { iso2: 'BD', name: 'Bangladesh', dialCode: '+880', flag: '🇧🇩' },
    { iso2: 'BB', name: 'Barbados', dialCode: '+1-246', flag: '🇧🇧' },
    ...
    { iso2: 'DM', name: 'Dominica', dialCode: '+1-767', flag: '🇩🇲' },
    { iso2: 'DO', name: 'Dominican Republic', dialCode: '+1-809', flag: '🇩🇴' },
    ...
    { iso2: 'GD', name: 'Grenada', dialCode: '+1-473', flag: '🇬🇩' },
    ...
    { iso2: 'JM', name: 'Jamaica', dialCode: '+1-876', flag: '🇯🇲' },
    ...
    { iso2: 'KN', name: 'Saint Kitts and Nevis', dialCode: '+1-869', flag: '🇰🇳' },
    { iso2: 'LC', name: 'Saint Lucia', dialCode: '+1-758', flag: '🇱🇨' },
    { iso2: 'VC', name: 'Saint Vincent and the Grenadines', dialCode: '+1-784', flag: '🇻🇨' },
    ...
    { iso2: 'TT', name: 'Trinidad and Tobago', dialCode: '+1-868', flag: '🇹🇹' },
...
].filter(c => !PRIORITY_SET.has(c.iso2))
 .sort((a, b) => a.name.localeCompare(b.name));

/** Full country list: priority countries first, then A–Z */
