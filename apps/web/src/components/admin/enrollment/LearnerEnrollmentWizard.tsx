...
export function LearnerEnrollmentWizard({ tenantSlug, tenantId }: LearnerEnrollmentWizardProps) {
    ...
    const handleComplete = async (data: Record<string, any>) => {
        ...
        const updateBody = {
            ...
            learner_data: {
                first_name: data.learner_first_name, surname: data.learner_surname,
                preferred_name: data.learner_preferred_name, dob: data.learner_dob,
                gender_code: data.gender_code, religion_code: data.religion_code,
                race_code: data.race_code, citizenship_type: data.citizenship_type,
                sa_id_number: data.sa_id_number, passport_number: data.passport_number,
