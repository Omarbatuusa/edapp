...
export default function UserProfile({ onBack, onLogout }: UserProfileProps) {
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden pb-10 bg-background-light dark:bg-background-dark text-slate-900 dark:text-white antialiased transition-colors duration-200">
            {/* Sticky Header */}
            <div className="sticky top-0 z-50 flex items-center bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl p-4 justify-between border-b border-gray-200/50 dark:border-white/10 shadow-sm transition-all duration-300">
                <button
                    onClick={onBack}
            ...
            <div className="flex flex-col items-center pt-8 pb-4 px-4">
                <div className="relative group cursor-pointer">
                    {/* Thicker premium ring */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-pink-600 to-purple-600 rounded-full opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt pointer-events-none"></div>
                    <div className="relative">
                        <div
                            className="bg-center bg-no-repeat bg-cover rounded-full h-32 w-32 shadow-2xl border-[4px] border-white dark:border-slate-800 transition-transform hover:scale-[1.02]"
                        ...
                        ></div>
                        <div className="absolute bottom-1 right-1 bg-primary text-white rounded-full p-2.5 border-4 border-white dark:border-slate-800 flex items-center justify-center shadow-lg hover:bg-blue-600 transition-colors z-10">
                ...
                <div className="mt-5 flex flex-col items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <Verified className="text-blue-500 h-6 w-6 fill-current" />
                    </div>
